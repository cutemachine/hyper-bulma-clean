...
export default () => (
  <section class='section'>
    <div class='container'>
      <div class='content'>
        <h1>What Is {config.projectName}?</h1>
        <p>{config.projectName} is a starter application which utilizes the power of Hyperapp combined with the Bulma CSS framework. You will be up and running with a new Hyperapp application in no time. The project structure is easy to grasp and should not stand in your way.</p>
        <h2>Technologies Used</h2>
        <p>The tech stack is simple but powerful. The starter uses modern JavaScript through Babel. So you have all the latest JS features and JSX available. Furthermore, you can use Hyperapp and replace React and Redux with it. Bulma is a great CSS framework which will help you to style your app in no time.</p>
        <ul>
        ...
        <ol>
          <li><code>git clone https://github.com/cutemachine/hyper-bulma-clean.git YOUR_PROJECT</code></li>
